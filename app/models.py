...
class ProjectProductivitySetting(db.Model):
    ...
    works_col = db.Column(db.String(80), nullable=False, default='Works_Beendet')
    ...
    dashboard_show_works = db.Column(db.Boolean, nullable=False, default=True)
    ...
    impact_show_works = db.Column(db.Boolean, nullable=False, default=False)
    ...
    warn_sign_on = db.Column(db.Float, nullable=False, default=80.75)
    warn_prod = db.Column(db.Float, nullable=False, default=72.25)
    warn_nach_per_call = db.Column(db.Float, nullable=False, default=45.0)
    warn_idle_max = db.Column(db.Float, nullable=False, default=15.0)
    ...
    label_works = db.Column(db.String(80), nullable=False, default='Works')
